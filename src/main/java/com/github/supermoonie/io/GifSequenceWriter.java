...
public class GifSequenceWriter {
    ...
    public static void main(String[] args) throws Exception {
        BufferedImage firstImage = ImageIO.read(new File("/Users/supermoonie/Downloads/test1.jpg"));
        BufferedImage endImage = ImageIO.read(new File("/Users/supermoonie/Downloads/test2.jpg"));

        ImageOutputStream output =
                new FileImageOutputStream(new File("/Users/supermoonie/Downloads/test.gif"));
