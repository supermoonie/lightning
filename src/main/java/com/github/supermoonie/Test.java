...
public class Test extends Application {
    ...
    private void addAppToTray() {
        try {
            ...
            URL iconUrl = Test.class.getResource("/lightning.png");
//            URL url = Test.class.getClassLoader().getResource("GameCenter-icon.png");
            Image image = Toolkit.getDefaultToolkit().getImage(iconUrl);
//            System.out.println(iconUrl.toString());
//            java.awt.Image image = ImageIO.read(new URL(iconUrl.toString()));
